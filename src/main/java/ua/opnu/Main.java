...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //task 2
        Student[] students = {
                new Student("Petrenko", "AI-241", new int[]{90, 80, 75}),
                new Student("Sydorenko",  "AI-242", new int[]{53, 41, 75}),
                new Student("Bondarenko", "AI-241", new int[]{100, 100, 100}),
                new Student("Kovalenko", "AI-243", new int[]{56, 59, 43}),
        };
